...
int main() {
    ...
    CPPUNIT_NS::stdCOut() << progress.getPointsEarned();
    CPPUNIT_NS::stdCOut() << "/";
    CPPUNIT_NS::stdCOut() << progress.getPointsPossible();
    CPPUNIT_NS::stdCOut() << "\n";
    CPPUNIT_NS::stdCOut() << "Correctness Normalized Grade: ";
    CPPUNIT_NS::stdCOut() << std::fixed;
    CPPUNIT_NS::stdCOut() << std::setprecision(1) << 3.0 * progress.getPointsEarned() / progress.getPointsPossible();
