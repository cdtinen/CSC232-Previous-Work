 ...
 *
 * @file   DifferenceOperationsUnitTest.h
 * @author Jim Daehn <jdaehn@missouristate.edu>
 * @brief  DifferenceOperationsUnitTest specification.
 */

#ifndef HW03_DIFFERENCE_OPERATIONS_UNIT_TEST_H__
#define HW03_DIFFERENCE_OPERATIONS_UNIT_TEST_H__

#include <cppunit/extensions/HelperMacros.h>
#include "BagInterface.h"
#include "SetArrayBag.h"

class DifferenceOperationsUnitTest : public CPPUNIT_NS::TestFixture {
CPPUNIT_TEST_SUITE(DifferenceOperationsUnitTest);
...
#endif // HW03_DIFFERENCE_OPERATIONS_UNIT_TEST_H__