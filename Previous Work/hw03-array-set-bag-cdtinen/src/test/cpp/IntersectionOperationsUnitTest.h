 ...
 *
 * @file   IntersectionOperationsUnitTest.h
 * @author Jim Daehn <jdaehn@missouristate.edu>
 * @brief  IntersectionOperationsUnitTest specification.
 */

#ifndef HW03_INTERSECTION_OPERATIONS_UNIT_TEST_H__
#define HW03_INTERSECTION_OPERATIONS_UNIT_TEST_H__

#include <cppunit/extensions/HelperMacros.h>
#include "BagInterface.h"
#include "SetArrayBag.h"

class IntersectionOperationsUnitTest : public CPPUNIT_NS::TestFixture {
CPPUNIT_TEST_SUITE(IntersectionOperationsUnitTest);
...
#endif // HW03_INTERSECTION_OPERATIONS_UNIT_TEST_H__